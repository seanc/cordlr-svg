# Contributing to cordlr-svg

First and foremost, thank you! We appreciate that you want to contribute to cordlr-svg, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for cordlr-svg**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for cordlr-svg:

- star the [project](https://github.com/seanc/cordlr-svg)
- tweet your support for cordlr-svg
...
- **version**: please note the version of cordlr-svg are you using
...
[so]: http://stackoverflow.com/questions/tagged/cordlr-svg